...
if render_mode == "Quick Mode":
    ...
    extent = st.sidebar.slider("Scan Area Size (Å)", 50, 500, 200, 50, key="extent_high")
    grid_size = st.sidebar.slider("Resolution (pixels)", 800, 3000, 1500, 100, key="grid_high")
...
if system_mode == "Bilayer":
    ...
    theta_layer2 = st.sidebar.slider("Twist Angle Layer 2 (°)", 0.0, 20.0, 1.1, 0.1, key="theta2")
    ...
    theta_layer2 = st.sidebar.slider("Twist Angle Layer 2 (°)", 0.0, 10.0, 4.8, 0.1, key="theta2_tri")
    theta_layer3 = st.sidebar.slider("Twist Angle Layer 3 (°)", -10.0, 10.0, -1.5, 0.1, key="theta3")
    st.sidebar.subheader("Strain for Layer 2")
    ...
    strain3 = st.sidebar.slider("Strain (%)", 0.0, 10.0, 0.0, 0.1, key="strain3")
    angle3 = st.sidebar.slider("Strain Direction (°)", 0.0, 180.0, 0.0, 1.0, key="angle3")
